...
export default function Services() {
   ...
   const handleSubmit = async (values) => {
      try {
         ...
         if (error) {
            message.error("Có lỗi xảy ra khi gửi liên hệ. Vui lòng thử lại!");
            return;
         }
               ...
               <div className="max-w-4xl mx-auto">
                  <div className="text-center mb-12">
                     ...
                     <Paragraph className="text-lg text-gray-200">
                        Bạn cần tư vấn về dịch vụ viễn thông? Hãy để lại thông tin, chúng tôi sẽ liên hệ với bạn sớm
                        nhất.
                     </Paragraph>
                  </div>
                           ...
                           <Col xs={24} className="text-center">
                              <Form.Item>
                                 <Button
                                    ...
                                    loading={submitting}
                                    size="large"
                                    className="bg-blue-900 hover:bg-blue-800 px-8 py-2 h-auto">
