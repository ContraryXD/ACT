         ...
         <Card
            ...
            cover={
               <div className="relative h-48 overflow-hidden">
                  <Image
                     src={project.images?.[0] || "/assets/images/default-project.jpg"}
                     alt={project.name}
                     fill
                  ...
                  <div className="space-y-2">
                     ...
                     {(project.start_date || project.end_date) && (
                        <p className="flex items-center text-gray-600">
                           ...
                           {project.end_date ? new Date(project.end_date).getFullYear() : "Đang thực hiện"}
                        </p>
                     )}
   ...
   const EmptyState = ({ type }) => (
      <div className="text-center py-12">
         <p className="text-gray-600">
            {type === "completed" ? "Chưa có dự án hoàn thành nào." : "Chưa có dự án đang thực hiện nào."}
         </p>
      </div>
   );
            ...
            <div className="container mx-auto px-6">
               <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                     ACT đã và đang thực hiện nhiều dự án lớn nhỏ trong lĩnh vực viễn thông và công nghệ thông tin, mang
                     lại giá trị thiết thực cho khách hàng và đối tác.
                  </p>
               </div>
                        ...
                        items={[
                           {
                              ...
                              label: (
                                 <span className="text-lg font-semibold">
                                    Dự án hoàn thành ({completedProjects.length})
                                 </span>
                              ),
                              children: (
                                 <div className="mt-8">
                           ...
                           },
                           {
                              ...
                              label: (
                                 <span className="text-lg font-semibold">
                                    Đang thực hiện ({ongoingProjects.length})
                                 </span>
                              ),
                              children: (
                                 <div className="mt-8">
