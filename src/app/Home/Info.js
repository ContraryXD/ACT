                     ...
                     <div className="home-info__lists">
                        <div className="home-info__lists--item item-1">
                           ...
                           <div className="home-info__lists--content content-1">
                              ...
                              <p>
                                 Gắn liền với chữ viết tắt tên gọi ACT, gồm 3 giá trị: AMOUT (Chân giá trị) –
                                 COOPERATION (Sự hợp tác) – TRUTH (Sự trung thực)
                              </p>
                           </div>
                        </div>
                        <div className="home-info__lists--item item-2">
                           <div className="home-info__lists--content content-2">
                              <h4>sứ mệnh</h4>
                              <p>
                                 Tối ưu giá thành và nâng cao chất lượng hạ tầng mạng lưới cho nhà mạng và cung cấp tốt
                                 nhất cho khách hàng cuối cùng là người sử dụng dịch vụ
                              </p>
                           </div>
                           <div className="home-info__lists--icon">
                        ...
                        <div className="home-info__lists--item item-3">
                           <div className="home-info__lists--content content-3">
                              <h4>Tầm nhìn</h4>
                              <p>
                                 Cung cấp dịch vụ kỹ thuật vận hành khai thác hạ tầng mạng lưới và quản lý khách hàng
                                 viễn thông, đầu tư và hợp tác cung cấp dịch vụ viễn thông, giải pháp CNTT hàng đầu Việt
                                 Nam.
                              </p>
                           </div>
                           <div className="home-info__lists--icon">
