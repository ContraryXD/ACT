               ...
               <Row gutter={[15, 0]}>
                  ...
                  <Col xl={12}>
                     <div className="history__content">
                        ...
                        <p className="para1">
                           Công ty Cổ phần Viễn thông ACT thành lập ngày 21 tháng 11 năm 2011; Hoạt động trên phạm vi
                           toàn quốc, với các lĩnh vực kinh doanh thuộc ngành viễn thông như: Thiết kế hạ tầng viễn
                           thông; Cho thuê hạ tầng viễn thông cáp quang; Thi công công trình viễn thông; Dịch vụ quản lý
                           vận hành hạ tầng viễn thông; Cung cấp thiết bị truyền hình số; Cung cấp hàng hóa, thiết bị
                           viễn thông; Cung cấp sản phẩm và giải pháp CNTT…
                        </p>
                        <p className="para2">
