...
const partners = [
   ...
   },
   {
      key: 5,
      imageSmall: (
         <Image src="/assets/images/Mobifone_Logo.png" alt="MobifoneLogo" width={defaultWidth} height={defaultHeight} />
      )
   },
   {
      key: 6,
   ...
   },
   {
      key: 7,
      imageSmall: (
         <Image src="/assets/images/NamLong_Logo.png" alt="NamLongLogo" width={defaultWidth} height={defaultHeight} />
      )
   },
   {
      key: 8,
            ...
            <Row>
               <Col xl={24} lg={24} md={24} sm={24} xs={24}>
                  <div className="partners-customers__head">
                     ...
                     <p>
                        Trên những chặng đường phát triển của ACT, mỗi đối tác và khách hàng đều là một hành trang quý
                        giá. ACT rất vinh hạnh khi được nhiều đối tác chọn lựa và hài lòng khi trao gửi niềm tin.
                     </p>
                  </div>
               </Col>
            </Row>
