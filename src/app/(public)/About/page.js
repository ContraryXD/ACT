  ...
  const coreValues = [
    {
      ...
      highlights: ["để hiểu và đáp ứng", "sự cải thiện và cải tiến liên tục", "nâng cao các giá trị và các dịch vụ trải nghiệm"],
    ...
    },
    {
      ...
      highlights: ["hợp tác và phối hợp", "tập thể", "cá nhân", "lắng nghe và tôn trọng", "đa dạng", "tinh thần đồng đội", "cởi mở, tích cực và phản hồi"],
      isRightAligned: true,
    },
    {
      icon: BulbOutlined,
            ...
            <div className="absolute bottom-0 right-0 w-100 md:w-4/5 lg:w-3/5 h-auto md:h-auto lg:h-auto z-20 mt-0 md:mt-0">
              ...
              <div className="bg-gray-100 p-4 md:p-6 lg:p-8 rounded-lg shadow-xl h-full overflow-hidden">
                <div className="mb-4">
                  ...
                  <h1 className="text-4xl md:text-xl lg:text-4xl font-bold text-center text-black mb-1">Khái quát về Công ty</h1>
                  <h2 className="text-4xl md:text-base lg:text-4xl font-bold text-center text-blue-900 mb-12">Cổ phần Viễn thông ACT</h2>
                </div>
                ...
                <div className="space-y-3 text-gray-700 leading-relaxed text-xs md:text-sm text-justify indent-8">
                  ...
                  <p>Với phương châm đặt chất lượng dịch vụ lên hàng đầu, cùng với sự tận tâm và trách nhiệm, chúng tôi hoàn toàn tin tưởng sẽ đáp ứng được sự kỳ vọng của Quý Khách hàng một cách tốt nhất.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative min-h-screen bg-gray-50 flex items-center justify-center py-16 px-6">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <Image src="/assets/images/bg_1.png" alt="Background overlay" width={800} height={600} className="object-contain" />
          </div>
        </div>{" "}
        {/* Content */}
          ...
          <Row gutter={[20, 20]} justify="center">
            {strengthPoints.map((strength, index) => (
              <Col key={index} xs={24} sm={12} lg={8}>
                {" "}
                <Card className="bg-white/90 backdrop-blur-sm rounded-lg shadow-xl hover:bg-white/95 transition-all duration-300 transform hover:scale-105" style={{ height: "100%" }} styles={{ body: { padding: "48px", textAlign: "center" } }}>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-40">
          <div className="text-center mb-16">
            <p className="text-red-600 text-md font-light uppercase tracking-tight">Giá trị cốt lõi của Công ty gắn liền với chữ viết tắt tên gọi ACT, gồm 3 giá trị</p>
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto mb-8">
              <p className="text-lg text-gray-600 leading-relaxed">Công ty Cổ phần Viễn thông ACT phát triển bền vững trên nền tảng kết hợp hài hòa các giá trị về lợi ích giữa doanh nghiệp, khách hàng và xã hội. Chúng tôi hướng đến mục tiêu là doanh nghiệp cung cấp dịch vụ kỹ thuật, vận hành khai thác hạ tầng mạng lưới và quản lý khách hàng viễn thông; đầu tư và hợp tác cung cấp dịch vụ viễn thông, giải pháp CNTT hàng đầu Việt Nam.</p>
            </div>
          </div>{" "}
